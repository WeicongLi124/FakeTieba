...
public class CenterAdapter extends BaseAdapter {
    ...
    public CenterAdapter(Context context, List<CenterItemBean> itemBeanList, View.OnClickListener clickListener) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        CenterItemBean itemBean = itemBeanList.get(position);
        if (view == null) {
            viewHolder = new CenterViewHolder();
            view = inflater.inflate(R.layout.home_center_item, viewGroup, false);
            ...
            viewHolder.shareLl = view.findViewById(R.id.center_item_share_ll);
            viewHolder.chatLl = view.findViewById(R.id.center_item_chat_ll);
            viewHolder.likeLl = view.findViewById(R.id.center_item_like_ll);
            viewHolder.shareTv = view.findViewById(R.id.center_item_share_tv);
            viewHolder.chatTv = view.findViewById(R.id.center_item_chat_tv);
            viewHolder.likeTv = view.findViewById(R.id.center_item_like_tv);
            viewHolder.likeIv = view.findViewById(R.id.center_item_like_iv);
        ...
        Glide.with(context).load(itemBean.getAvatar()).apply(RequestOptions.bitmapTransform(new CircleCrop())).into(viewHolder.avatarIv);
        ...
        viewHolder.shareLl.setTag(R.id.center_item_share_ll, position);
        viewHolder.chatLl.setTag(R.id.center_item_chat_ll, position);
        viewHolder.likeLl.setTag(R.id.center_item_like_ll, position);
